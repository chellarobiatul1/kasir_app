...
import 'laporan_pelanggan.dart';

class LaporanKasir extends StatefulWidget {
  const LaporanKasir({super.key});

  @override
  State<LaporanKasir> createState() => _LaporanKasirState();
}

class _LaporanKasirState extends State<LaporanKasir> {
        ...
        onTap: () {
          ...
          if (index == 1) {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (_) => const LaporanPelanggan()),
            );
          }
        },
        child: Container(
